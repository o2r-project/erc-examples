...
__Figure 3:__ Example of INSYDE damage functions considering the following event variables: flow velocity = 2.0 m s −1 , flood duration = 24 h, sediment concentration = 0.05, and water quality = presence of pollutants. Damage functions for entire building and different building components. 
