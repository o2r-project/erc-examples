...
``` {r "iris plots", echo=FALSE, cache=FALSE, results="hide", message=FALSE , warning=FALSE, comment=FALSE, warning=FALSE}
...
``` {r "mtcars plots", echo=FALSE, cache=FALSE, results="hide", message=FALSE , warning=FALSE, comment=FALSE, warning=FALSE}
...
mtcars$num_gears <- factor(mtcars$gear,levels=c(3,4,5),
   labels=c("3 gears","4 gears","5 gears"))
mtcars$automatic_V_manual <- factor(mtcars$am,levels=c(0,1),
...
qplot(mpg, data=mtcars, geom="density", fill=num_gears, alpha=I(.5),
   main="Distribution of Gas Milage", xlab="Miles Per Gallon",
   ylab="Density")

# Scatterplot of mpg vs. hp for each combination of gears and cylinders
# in each facet, transmittion type is represented by shape and color
qplot(hp, mpg, data=mtcars, shape=automatic_V_manual, color=automatic_V_manual,
